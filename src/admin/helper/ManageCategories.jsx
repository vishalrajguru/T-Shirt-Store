...
import {deleteCategory,getCategories } from './adminApiCall'
            ...
            <div className="col-12">
                ...
                {category.map((item, index) => {
                    return (<div key={index} className="row text-center mb-2">
                        ...
                        <div className="col-4">
                            <Link className="btn btn-success" to={`/admin/category/update/${item._id}`}>Update</Link>
                        </div>
                        <div className="col-4">
                            <button onClick={() => { deleteTheCategory(item._id) }} className='btn btn-danger'>Delete</button>
                        </div>
